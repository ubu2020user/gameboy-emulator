...
class Cartridge {
  ...
  void load(List<int> data) {
    ...
    this.gameboyType =
        this.readByte(0x143) == 0x80 ? GameboyType.COLOR : GameboyType.CLASSIC;
  ...
  MMU? createController(CPU cpu) {
    if (this.type == CartridgeType.ROM) {
      ...
      return MMU(cpu);
    } else if (this.type == CartridgeType.MBC1 ||
        this.type == CartridgeType.MBC1_RAM ||
        this.type == CartridgeType.MBC1_RAM_BATT) {
      print('Created MBC1 unit.');
      return MBC1(cpu);
    } else if (this.type == CartridgeType.MBC2 ||
        this.type == CartridgeType.MBC2_BATT) {
